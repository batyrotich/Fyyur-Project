...
def create_venue_submission():
	...
	try:
		...
		if name_dub:
			...
			createVenue = Venue(name=venueName, city=venueCity, state=venueState, address=venueAddress, phone=contactNumber, genres=songGenres,
			                    facebook_link=facebookLink, image_link=imageLink, website_link=websiteLink, seeking_talent=seekingTalent, seeking_description=seekingDescription)
